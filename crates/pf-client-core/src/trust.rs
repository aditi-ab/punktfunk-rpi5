...
pub struct Settings {
    ...
    /// and HEVC the native pf-vkdecode rung sits immediately above FFmpeg-Vulkan;
    /// then VAAPI/D3D11VA, then software — see `video::Decoder::new` for the
    /// per-vendor order), `"vulkan"`, `"vaapi"`, `"d3d11va"`, `"native-vulkan"`,
    /// `"software"`.
