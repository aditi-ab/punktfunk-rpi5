...
RAMP_STEP_BYTES|const RAMP_STEP_BYTES: u64 = 3_000_000;|const RAMP_STEP_BYTES: u64 = 300_000;
RAMP_WALL_PCT|const RAMP_WALL_PCT: u64 = 90;|const RAMP_WALL_PCT: u64 = 50;
RAMP_CEILING_PCT|const RAMP_CEILING_PCT: u32 = 85;|const RAMP_CEILING_PCT: u32 = 60;
